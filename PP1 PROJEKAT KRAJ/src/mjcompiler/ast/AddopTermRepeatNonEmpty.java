...
public class AddopTermRepeatNonEmpty extends AddopTermRepeat {

    private AddopTermRepeat AddopTermRepeat;
    private Addop Addop;
    private Term Term;

    public AddopTermRepeatNonEmpty (AddopTermRepeat AddopTermRepeat, Addop Addop, Term Term) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AddopTermRepeatNonEmpty(\n");
